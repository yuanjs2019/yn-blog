    ...
    <aside class="ss-layout-aside">
        ...
        <div class="ss-card ss-aside-tags">
            ...
            <ul class="tag-list">
                ...
                <li class="tag"><a href="${re.contextPath}/classfy/${classifg.classifyCode}">${classifg.classifyName}</a></li>
                </#list>
            </ul>
        </div>
        <div class="ss-card ss-aside-tags">
            ...
            <ul class="tag-list">
                ...
                <li class="tag"><a href="${re.contextPath}/series/${seriesg.sericsCode}">${seriesg.sericsName}</a></li>
                </#list>
            </ul>
        </div>
    </aside>
